...
class BarCharPaymentEvents extends StatefulWidget {
  const BarCharPaymentEvents(
      {super.key,
  ...
  final List<PaymentEventModel> dataMetric;

  @override
  State<BarCharPaymentEvents> createState() => _BarCharPaymentEventsState();
}

class _BarCharPaymentEventsState extends State<BarCharPaymentEvents> {
  int touchedGroupIndex = -1;

  List<PaymentEventModel> get currentPageData {
  ...
  List<BarChartGroupData> getData(double barsWidth, double barsSpace) {
    ...
    final List<PaymentEventModel> currentPageData = this.currentPageData;
