...
void main() {
  group("EventallRepositoryImplClass", () {
    test(
      "",
      () async {
        ...
        final eventAllRepositoryImpl =
            EventRepositoryImpl(apiService: mockApiService);

        final result = await eventAllRepositoryImpl.getEventAll();
    ...
    test(
      ...
      () async {
        ...
        final response = await eventAllRepositoryImpl.getEventAll();
